            ...
            <div className="container">
                <div className="InputBox">
                    <div style={{ display: 'flex', flexDirection: "column", alignContent: "center", justifyContent: "center", width: "100%", margin: "0 0 30px" }}>
                        ...
                        <h1 style={{ fontFamily: 'Roboto sans-serif', color: "#595a59" }}>Poppy Central</h1>
                        <div className="SpecialProjects">
                            <p className="mediumTitle" style={{ color: "#595a59" }}>Create:</p>
                            <div className="specialBox">
                                <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center", padding: "15px" }}>
                                    {/* <div className="grayCircle"> */}
                                    <img src={contract} alt="checkmark" style={{ width: "48px" }} />
                                    {/* </div> */}
                                    <ListItem>
                            ...
                            <div className="specialBox">
                                <div style={{ display: "flex", flexDirection: "row", justifyContent: "space-between", alignItems: "center" }} onClick={() => this.props.history.push('/app-main/omg')} >
                                    ...
                                    <AvatarGroup max={4}>
                                        ...
                                        <Avatar alt="Travis Howard" src="https://images.pexels.com/photos/2830332/pexels-photo-2830332.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" />
                                    </AvatarGroup>
                                </div>
                                <div className="Line" />
                            </div>
